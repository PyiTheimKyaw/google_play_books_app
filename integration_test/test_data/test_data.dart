...
const String SHELVES_TAB="Shelves";
const String YOUR_BOOKS_TAB="Your books";
...
const String DELETE_SHELF_BUTTON="Delete Shelf";
const String RENAME_SHELF="Rename Shelf";
const String TWOX_GRID="2x grid";
const String THREEX_GRID="3x grid";
const String SEARCHED_QUERY="flutter";
const String SEARCHED_BOOK="A LONG WALK TO WATER";
const String SEARCHED_BOOK_RESULT="Computers";
